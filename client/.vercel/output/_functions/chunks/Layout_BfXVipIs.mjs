import { c as createComponent, m as maybeRenderHead, h as renderScript, e as renderTemplate, f as renderComponent, a as createAstro, b as addAttribute, r as renderHead, d as renderSlot } from './astro/server_cUBcAsSp.mjs';
import 'clsx';
/* empty css                                   */
import { F as Facebook, I as Instagram } from './brand-instagram_CoiFrTpF.mjs';
import { c as createSvgComponent } from './runtime_C0IVtbA6.mjs';
/* empty css                                   */
...
}, "C:/Proyectos/MVA-FOOD/src/components/Shared/Header.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/mva-logo-rb.png"><meta name="description"${addAttribute(description, "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:type" content="website"><meta property="og:image" content="/mva-logo-rb.png"><meta property="og:url"${addAttribute(Astro2.url, "content")}><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image" content="/mva-logo-rb.png"><link rel="stylesheet" href="/src/styles/global.css"><title>${title}</title>${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BackToTop", $$BackToTop, {})} ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
}, "C:/Proyectos/MVA-FOOD/src/layouts/Layout.astro", void 0);
