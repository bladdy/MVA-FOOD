/* empty css                               */
import { c as createComponent, m as maybeRenderHead, e as renderTemplate, a as createAstro, b as addAttribute, d as renderSlot, f as renderComponent, h as renderScript } from '../chunks/astro/server_-OnrOxK6.mjs';
import 'clsx';
import { $ as $$Layout } from '../chunks/Layout_DXhUJxF1.mjs';
import '../chunks/index_DfOMS8cV.mjs';
import { $ as $$Image } from '../chunks/_astro_assets_Sjmo0155.mjs';
import { $ as $$CharacteristicsSection } from '../chunks/CharacteristicsSection_ZBR-CKNV.mjs';
import { c as createSvgComponent } from '../chunks/runtime_DHo21nlC.mjs';
...
const qr = new Proxy({"src":"/_astro/codigo_qrmr.wyZMTeMl.png","width":300,"height":300,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Proyectos/MVA-FOOD/client/public/img/codigo_qrmr.png";
							}
...
Prueba la aplicación gratis durante 7 días y descubre cómo puede transformar tu restaurante. Ofrecemos planes flexibles para adaptarnos a las necesidades de tu negocio. Elige el que mejor se ajuste a ti.
</p> </div> <div class="max-w-6xl mx-auto grid grid-cols-1 
    md:grid-cols-2 lg:grid-cols-3 gap-8"> <div class="bg-white border-orange-600 border rounded-lg shadow-lg p-4 flex flex-col items-center relative group h-[470px]"> <div> <div class="text-center mb-6 font-bold"> <p class="text-orange-600">PLAN GOLD</p> <p class="text-orange-600">$6,000/ANUAL</p> <h3 class="text-3xl text-orange-600">$600/MES</h3> </div> <ul class="list-image-[url(@assets/svg/check.svg)] list-outside mb-4 text-orange-900 "> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Código QR</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}QR personalizado</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Menú personalizado</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Categoría</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Ilimitados platos</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Soporte 24/7</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Totalmente Autogestionable</li> </ul> </div> <a href="/precios" class="bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-colors duration-300 absolute bottom-4">Elegir Plan</a> </div> <div class="bg-white border-orange-600 border rounded-lg shadow-lg p-4 flex flex-col items-center relative group h-[470px]"> <div> <div class="text-center mb-6 font-bold"> <p class="text-orange-600">PLAN PLATINUM</p> <p class="text-orange-600">$20,000/ANUAL</p> <h3 class="text-3xl text-orange-600">$2,800/MES</h3> </div> <ul class="list-image-none list-outside mb-4 text-orange-900"> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Código QR</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}QR personalizado</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Perfil Restaurant</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Menú personalizado</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Categoría</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Ordenes (<span class="text-orange-600 font-bold">Ilimitadas</span>)</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Mesas (<span class="text-orange-600 font-bold">10</span>)</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Agente Mesero</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Ilimitados platos</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Soporte 24/7</li> <li class="flex gap-1">${renderComponent($$result, "Check", Check, {})}Totalmente Autogestionable</li> </ul> </div> <a href="/precios" id="platinunButton" class=" bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-colors duration-300 absolute bottom-4">Elegir Plan</a> </div> <div class="bg-white border-orange-600 border rounded-lg shadow-lg p-4 flex flex-col items-center relative group h-[470px]"> <div> <div class="text-center mb-6 font-bold"> <p class="text-orange-600">VER DEMO</p> <h3 class="text-3xl text-orange-600">DEMO</h3> </div> </div> ${renderComponent($$result, "Image", $$Image, { "src": qr, "alt": "Qr Demo", "title": "Qr Demo", "width": "162", "height": "162", "class": "inline-block w-22 transition-transform group-hover:scale-110 mb-10" })} <a href="/menus/pollos-los-hermanos" class="bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-colors duration-300 absolute bottom-4">Ver Demo</a> </div> </div> </section> ${renderScript($$result, "C:/Proyectos/MVA-FOOD/client/src/components/Sections/PreciosSection.astro?astro&type=script&index=0&lang.ts")}`;
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Mr. Men\xFAs - Inicio" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HomeSection", $$HomeSection, {})} ${renderComponent($$result2, "CharacteristicsSection", $$CharacteristicsSection, {})} ${renderComponent($$result2, "AdminSection", $$AdminSection, {})} ${renderComponent($$result2, "RestaurantsBarSection", $$RestaurantsBarSection, {})} ${renderComponent($$result2, "PreciosSection", $$PreciosSection, {})} ${renderComponent($$result2, "ContactoSection", $$ContactoSection, {})} ` })}`;
