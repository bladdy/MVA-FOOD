...
const $$Precios = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Mr. Men\xFAs - Precios" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex items-center justify-center h-screen bg-gray-100 p-8"> <div class="text-center"> <img src="/img/work.png" alt="MVA logo featuring a stylized hamburger, food truck, utensils, and large text MVA on an orange circle background, conveying a friendly and inviting food-related theme" class="mx-auto mb-4 h-48"> <h1 class="mt-4 text-5xl font-semibold tracking-tight text-orange-800 sm:text-7xl">
Estamos trabajando
