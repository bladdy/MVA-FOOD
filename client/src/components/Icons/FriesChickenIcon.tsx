...
const FriesChickenIcon: React.FC<Props> = ({ className }) => {
  return (

      <svg fill="currentColor" className={className} height="24" width="24" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
     viewBox="0 0 100 100" >
...
export default FriesChickenIcon;
