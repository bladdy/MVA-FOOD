            ...
            {total >= metaEnvioGratis ? (
              ...
              <div className="flex justify-between items-center mb-1">
                  <span className="text-green-600 font-semibold flex items-center justify-center gap-1">
                    !Listo! Ya tienes env¡o gratis <CheckIcon className="inline-block w-4 h-4 text-green-500" />
                  </span>
              ...
              <>
                <div className="flex justify-between items-center mb-1">
                  <span>
                    Te faltan <strong>${(metaEnvioGratis - total).toFixed(2)}</strong> para env¡o gratis
                  </span>
                  <span className="text-xs text-gray-500 ml-2">Meta: ${metaEnvioGratis}</span>
                </div>
                <div className="w-full h-2 bg-gray-300 rounded-full overflow-hidden">
                ...
                return (
                  <li key={idx} className="flex flex-col border-b pb-4">
                    <div className="flex items-start gap-4">
                      <div className="w-16 h-16 rounded-lg bg-orange-100 flex items-center justify-center text-orange-500 font-bold text-xs">
                        Combo
                      </div>
                      <div className="flex-1">
                        <button
                          onClick={() => setComboExpandido(expandido ? null : idx)}
                          className="text-md font-semibold text-gray-800 hover:text-orange-600 text-left"
                        >
