  ...
  return (
    <section className="lg:w-1/2 w-full rounded-lg px-8">
      <div className="mx-auto py-4 flex flex-col justify-center items-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col lg:grid lg:grid-cols-5 grid-cols-12 w-full mt-4">
          <div className="grid grid-cols-2 col-span-2">
            <select
              name="name"
              onChange={handleChange}
              className="w-full p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-600"
            >
